...
public class FloorGenerator : ScriptableObject
{
	...
	private void AddItems ()
	{
		...
		// TODO: Create more items and equipment. No sense in making this method before the items it would generate even are implemented.
		// Set up a counter to check for how much equipment is dropped on a single floor, making sure that one floor doesn't just have a gigantic pile of gear.
		// Check for the floor counter, so that the first floor doesn't have ridiculously powerful gear.
